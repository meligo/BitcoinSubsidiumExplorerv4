AmCharts.themes.dark = {
    ...
    AmCoordinateChart: {
        colors: ["#226d7f", "#226d7f", "#b6d2ff", "#c9e6f2", "#c9f0e1", "#e8d685", "#e0ad63", "#d48652", "#d27362", "#495fba", "#7a629b", "#8881cc"]
    },
    AmStockChart: {
        colors: ["#226d7f", "#226d7f", "#ae85c9", "#c9f0e1", "#d48652", "#629b6d", "#719dc3", "#719dc3"]
    },
    AmSlicedChart: {
        outlineAlpha: 1,
        outlineThickness: 2,
