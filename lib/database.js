...
module.exports = {
    ...
    get_chart: function (cb) {
        lib.get_blockcount(function (blockcount) {
            ...
            Tx.aggregate([{ $match: { 'blockindex': { $gt: last - 300, $lt: last } } }, { $group: { _id: '$blockindex', block: { $first: '$blockindex' }, powdiff: { $first: '$difficulty' }, netHash: { $first: '$netHash' } } }, { $sort: { block: 1 } }]).exec(function (err, pows) {
                if (err) {
                }
                return cb(pows);
            });
